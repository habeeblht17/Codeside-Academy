                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                <a href="{{route('instructor.status-change', [$instructor->uuid, 1])}}" class="btn-action approve-btn mr-30 pl-2" title="Make as approve">
                                                    {{__('Approve')}}
                                                </a>
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            {{-- <div class="action__buttons">
                                                ...
                                                <a href="javascript:void(0);" data-url="{{route('instructor.delete', [$instructor->uuid])}}" title="Delete" class="btn-action mr-30 delete">
                                                    <img src="{{asset('admin/images/icons/trash-2.svg')}}" alt="trash">
                                                </a>
                                            </div> --}}
