...
@section('content')
                    ...
                    <div class="col-12 col-md-7 col-lg-5">
                        <div class="hero-content">
                            ...
                            <div class="hero-btns">
                                ...
                                <a href="{{ route('sign-up-instructor') }}" target="" rel="noopener noreferrer" class="theme-btn theme-button2">Become Instructor <i data-feather="arrow-right"></i></a>
                ...
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div class="video-area-right position-relative">
                        ...
                        <div class="col-12 section-btn">
                            <a href="{{ route('sign-up-instructor') }}" class="theme-btn theme-button1">{{ __('Become an Instructor') }} <i
                    ...
                    <div class="faq-area-right position-relative">
                        ...
                        <div class="still-no-luck radius-3 bg-white position-absolute">
                            ...
                            <p>{{ __('Then feel free to') }} <a href="{{ route('contact') }}"
                                                                    class="text-decoration-underline color-heading">{{ __('Contact Us') }}</a>,
    ...
    <section class="course-instructor-support-area bg-light section-t-space {{ @$home->instructor_support_area == 1 ? '' : 'd-none' }}">
        ...
        <!--                    <a href="https://codesideacademy.com/courses" class="theme-btn theme-button1 theme-button3">Popular Courses<i data-feather="arrow-right"></i></a>-->
        <!--                </div>-->
        <!--            </div>-->
