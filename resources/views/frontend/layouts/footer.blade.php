                    ...
                    <div class="footer-widget footer-contact-info">
                        ...
                        <div class="footer-links d-flex">
                            <ul>
                                ...
                                <li><span class="iconify" data-icon="fluent-emoji-high-contrast:telephone-receiver"></span></span><a href="tel:+2349154574498">{{ __(get_option('app_contact_number')) }}</a></li>
                                <li><span class="iconify" data-icon="ic:round-email"></span><a href="mailto:info@codesideacademy.com">{{ __(get_option('app_email')) }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="footer-bottom-nav">
                        <ul class="d-flex justify-content-end">
                            <li><a href="{{ route('sign-up-instructor') }}">{{__('Become Instructor')}}</a></li>
