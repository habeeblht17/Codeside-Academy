    ...
    public function run()
    {
        Blog::insert([
            ['uuid' => Str::uuid()->toString(), 'user_id'=> 1, 'title'=>'60 Common C# Interview Questions in 2022: Ace Your Next Interview',
                ...
                'image' => 'uploads_demo/blog/1.jpg', 'status' => 1, 'blog_category_id' => 1, 'view' => 0, 'created_at' => now(), 'updated_at' => now()
                ...
                'image' => 'uploads_demo/blog/2.jpg', 'status' => 1, 'blog_category_id' => 2, 'view' => 0, 'created_at' => now(), 'updated_at' => now()
                ...
                'image' => 'uploads_demo/blog/3.jpg', 'status' => 1, 'blog_category_id' => 1, 'view' => 0, 'created_at' => now(), 'updated_at' => now()
                ...
                'image' => 'uploads_demo/blog/2.jpg', 'status' => 1, 'blog_category_id' => 1, 'view' => 0, 'created_at' => now(), 'updated_at' => now()
            ],
        ]);
    }
}
