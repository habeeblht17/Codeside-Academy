...
Route::group(['middleware' => 'guest'], function () {
    ...
    Route::get('become-an-instructor', [RegistrationController::class, 'signUpInstructor'])->name('sign-up-instructor');
    Route::post('store-sign-up', [RegistrationController::class, 'storeSignUp'])->name('store.sign-up')->middleware('isDemo');
    Route::post('instructor-sign-up', [RegistrationController::class, 'storeInstructorSignUp'])->name('store.instructor.sign-up')->middleware('isDemo');
});
