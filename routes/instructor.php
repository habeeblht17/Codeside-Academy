...
Route::prefix('account')->group(function () {
    Route::group(['prefix' => 'accounts'], function () {
        ...
        Route::post('save-my-account', [AccountController::class, 'saveMyAccount'])->name('instructor.my-account')->middleware('isDemo');
...
Route::get('all-students', [StudentController::class, 'allStudentIndex'])->name('instructor.all-student');
Route::get('all-paid-students', [StudentController::class, 'allPaidStudent'])->name('instructor.paid-student');
